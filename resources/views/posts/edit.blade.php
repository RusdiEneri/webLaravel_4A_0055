...
<head>
    ...
    <title>Edit Berita - Kabar Burung</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm sticky-top">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('posts.show', $post->id) }}">Lihat Berita</a>
                </li>
            </div>
        </div>
    </nav>
                ...
                <div class="form-container">
                    ...
                    <form action="{{ route('posts.update', $post->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="publisher" name="publisher" value="{{ old('publisher', $post->publisher) }}">
                        </div>
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-danger">Perbarui Berita</button>
